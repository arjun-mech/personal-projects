...
while float(Winding_Direction_b[axis]*Propagation_Array_b[1][axis]) < float(Start_Point[axis]):
...
#print("\n",path_centre,"\n",path_angle)
join_centre,join_angles,y = interpolate(path_centre, path_angle, path_centre_b,path_angle_b)

for i in range(len(join_centre)):  
    print(join_angles[i],join_centre[i])

plt.plot(join_centre,join_angles,color = 'green')
